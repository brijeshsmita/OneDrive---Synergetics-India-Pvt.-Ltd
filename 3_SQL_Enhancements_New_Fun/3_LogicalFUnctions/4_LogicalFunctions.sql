...
-- Select iif(@X>@Y, 50, 60) As IIFResult returns false value 
--that is 60.


DECLARE @ShowIndex INT;
SET @ShowIndex =2;
Select Choose(@ShowIndex, 'M','N','H','P','T','L','S','H') As MyCol
...
SELECT NationalIDNumber,
       ...
       CHOOSE(MONTH(HireDate),'Winter', 'Winter', 'Winter',            'Spring', 'Spring', 'Spring',
